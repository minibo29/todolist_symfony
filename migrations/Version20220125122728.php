 ...
 */
final class Version20220125122728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, priority_id INT DEFAULT NULL, type_id INT DEFAULT NULL, status_id INT DEFAULT NULL, strTaskName VARCHAR(50) NOT NULL, strTaskDesc TINYTEXT NOT NULL, dtmScheduleTime DATE DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_527EDB25497B19F9 (priority_id), INDEX IDX_527EDB25C54C8C93 (type_id), INDEX IDX_527EDB256BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
